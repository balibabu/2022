...
class ESP8266:
    ...
    def doHttpGet(self,host,path,user_agent="RPi-Pico", port=80):
        ...
        https://api.openweathermap.org/data/2.5/weather?q=bhubaneswar&appid=7ee2c515dc46284a0eee620191317d9b&units=metric
        host=https://api.openweathermap.org
        path=/data/2.5/weather?q=bhubaneswar&appid=7ee2c515dc46284a0eee620191317d9b&units=metric
        Parameter:
